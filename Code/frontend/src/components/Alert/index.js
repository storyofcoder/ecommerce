...
var CloseIcon = function CloseIcon() {
  return React.createElement(
    BaseIcon,
    { color: "black", pushRight: false, verticalAlign: "middle" },
...
var alertStyle = {
  ...
  color: "rgba(29, 33, 49, 0.93)",
  padding: "16px",
  borderRadius: "3px",
  display: "flex",
  justifyContent: "space-between",
  alignItems: "center",
  boxShadow: "rgba(233, 185, 36, 0.21) 0px 0px 0px 2px",
...
var AlertTemplate = function AlertTemplate(_ref) {
  ...
  return React.createElement(
    "div",
    { className: 'acc-alert', style: _extends({}, alertStyle, style) },
